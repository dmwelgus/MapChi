...
includes community areas with 1 or more homicides. In the example above these regions are recoded as zeros instead of missing. Missing values typically show up as an ugly grey color. For example,  
