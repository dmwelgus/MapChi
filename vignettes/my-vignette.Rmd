...
In my experience, discrete heat maps are usually a bit easier to interpret than continuous heat maps. Making a discrete map is a little more labor intensive than making a continuous map, but the additional steps are pretty straightforward. 
